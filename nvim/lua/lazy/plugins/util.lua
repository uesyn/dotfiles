return {
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<Leader>td', ":Octo issue edit uesyn/note 1<CR>", { noremap = true, silent = true })
      vim.keymap.set('n', '<Leader>ml', ":Octo issue list uesyn/note<CR>", { noremap = true, silent = true })
      vim.keymap.set('n', '<Leader>mc', ":Octo issue create uesyn/note<CR>", { noremap = true, silent = true })
    end
  },
}
